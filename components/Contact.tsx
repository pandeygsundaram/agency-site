...
const Contact: React.FC = () => {
  ...
  return (
    <section
      id="connect"
      className="py-32 px-6 md:px-12 bg-background relative border-t border-border"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-center gap-12 lg:gap-24">
          ...
          <FadeIn
            delay={0.2}
            className="hidden lg:flex flex-col items-center justify-center self-stretch"
          >
            ...
            <div className="h-full bg-background p-1 relative flex flex-col justify-center">
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="group border-b border-border focus-within:border-foreground transition-colors">
                  <label
                    htmlFor="name"
                    className="block text-[10px] font-mono uppercase text-muted mb-1"
                  >
                    Name
                  </label>
                  <input
